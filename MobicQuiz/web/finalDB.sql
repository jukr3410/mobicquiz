...
ADD COLUMN  levelno   varchar(45);

ALTER TABLE subjects
ADD FOREIGN KEY (levelno) REFERENCES levels(levelno);
...
INSERT INTO MOBIC.SUBJECTS (SUBJECTNO, SUBJECT,LEVELNO) 
	VALUES ('101', 'Math 1','1');
INSERT INTO MOBIC.SUBJECTS (SUBJECTNO, SUBJECT,LEVELNO) 
	VALUES ('102', 'Math 2','2');
INSERT INTO MOBIC.SUBJECTS (SUBJECTNO, SUBJECT,LEVELNO) 
	VALUES ('201', 'Science 1','1');
INSERT INTO MOBIC.SUBJECTS (SUBJECTNO, SUBJECT,LEVELNO) 
	VALUES ('202', 'Science 2','2');
INSERT INTO MOBIC.SUBJECTS (SUBJECTNO, SUBJECT,LEVELNO) 
	VALUES ('301', 'Art 1','1');
INSERT INTO MOBIC.SUBJECTS (SUBJECTNO, SUBJECT,LEVELNO) 
	VALUES ('302', 'Art 2','2');
...
INSERT INTO MOBIC.SUBJECTS (SUBJECTNO, SUBJECT,LEVELNO,LEVELNO) 
	VALUES ('203', 'Science 3','3');
...
INSERT INTO MOBIC.STUDENTS (STUDENTNO, "NAME", EMAIL, PASSWORD, ACTIVATEKEY, ACTIVATED, LEVELNO) 
	VALUES ('61130500022', 'Wtf', 'nuannirun3410@gmail.com', '12345', '12345', 'activated', '1');
...
INSERT INTO MOBIC.TEACHERS (TEACHERNO, "NAME", EMAIL, PASSWORD, ACTIVATEKEY, ACTIVATED) 
	VALUES ('0987654321', 'John Wick', 'jaturong3410@gmail.com', '0987654321', '12345', 'activated');
...
INSERT INTO MOBIC.QUIZS (QUIZNO, TITLE, "TIME", FULLSCORE, LEVELNO, SUBJECTNO, STATUS, TEACHERNO) 
	VALUES ('3', 'Calculus', 10, 20, '4', '201', 'on', '0987654321');
...
INSERT INTO MOBIC.HISTORYS (HISTORYNO, SCORE, "DATE", QUIZNO, STUDENTNO) 
	VALUES ('2', 10, '2019-11-19', '3', '61130500022');
INSERT INTO MOBIC.HISTORYS (HISTORYNO, SCORE, "DATE", QUIZNO, STUDENTNO) 
	VALUES ('3', 9, '2019-11-21', '2', '61130500011');
INSERT INTO MOBIC.HISTORYS (HISTORYNO, SCORE, "DATE", QUIZNO, STUDENTNO) 
	VALUES ('4', 8, '2019-11-21', '2', '61130500011');
INSERT INTO MOBIC.HISTORYS (HISTORYNO, SCORE, "DATE", QUIZNO, STUDENTNO) 
	VALUES ('5', 7, '2019-11-21', '2', '61130500022');
INSERT INTO MOBIC.HISTORYS (HISTORYNO, SCORE, "DATE", QUIZNO, STUDENTNO) 
	VALUES ('6', 6, '2019-11-21', '1', '61130500011');
